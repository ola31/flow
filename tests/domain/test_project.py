...
class TestProjectNavigation:
    ...
    def test_get_current_score_sheet(self):
        """현재 시트 가져오기"""
        project = Project(name="테스트")
        sheet = ScoreSheet(name="현재곡", image_path="sheet.png")
        project.add_score_sheet(sheet)
    ...
    def test_next_score_sheet(self):
        """다음 시트로 이동"""
        project = Project(name="테스트")
        project.add_score_sheet(ScoreSheet(name="곡1", image_path="s1.png"))
        project.add_score_sheet(ScoreSheet(name="곡2", image_path="s2.png"))
        project.current_sheet_index = 0
